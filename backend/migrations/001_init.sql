...
-- 근거: docs/7-erd.md, docs/1-domain-definition.md(v1.6) 5장, docs/4-project-principle.md 3장(네이밍 원칙)
...
CREATE TABLE restaurants (
    id                      SERIAL PRIMARY KEY,
    name                    TEXT NOT NULL,
    cost_per_person         INTEGER NOT NULL,  -- 1인 예상 비용(원). events.budget_per_person과 비교해 추천 후보를 필터링(C3/C6)
