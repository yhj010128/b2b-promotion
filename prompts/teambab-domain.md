...
| 엔티티 | 주요 속성 | 관계 |
|---|---|---|
| 사용자 | id, 이름, 역할(팀장/팀원) | 1 사용자 - N 선호의견, N 만족도평가 |
...
| 추천 결과 | id, 회식일정id, 식당후보 목록(식당명, 점수) | N:1 회식일정 |
| 만족도 평가 | id, 회식일정id, 사용자id, 별점(1~5), 한줄평 | N:1 회식일정, N:1 사용자 |
| 식당 | id, 이름, 최근 방문 이력, 누적 평균 만족도 점수 | 1 식당 - N 만족도평가(간접, 회식일정 경유) |
