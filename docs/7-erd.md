...
> 도메인 정의서(`1-domain-definition.md` 5장) v1.6, PRD(`2-PRD.md`) v1.2 기준.
...
- **식당.일인예상비용 (`restaurants.cost_per_person`)**: 도메인 정의서 v1.6에 추가된 속성. 추천 시 `회식일정.예산` 이상인 식당을 걸러내는 필터 기준이자(C3·C6), 추천 카드에 표시되는 "예상 1인 비용"(`6-wireframe.md` 4장)의 원본 값이다.
