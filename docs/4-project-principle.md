...
> 본 문서는 `1-domain-definition.md`(도메인 정의서 v1.4), `2-PRD.md`(PRD v1.2), `3-user-scenario.md`를 기반으로, 5일/1인 개발 규모의 MVP에 맞는 실용적 구조 원칙만 정의한다. 이 규모를 넘어서는 레이어링·추상화·조직 규칙은 다루지 않는다.
